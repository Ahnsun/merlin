...
def eval():
    ...
    for idx, line in enumerate(data):
        ...
        results[line['key']] = outputs

    if 'cn' in data_args.eval_file_path.lower():
        result_filename = "mmvet_cn.json"
    else:
        result_filename = "mmvet.json"

    with open(os.path.join(model_args.model_name_or_path, result_filename), 'w', encoding="utf-8") as f:
